# Multinomial Logit Mode Choice {#chap3}
Currently, BEAM uses a multinomial logit mode choice model. This model takes in certain parameters and inputs and uses them to estimate the likely mode choice for each user in their repsective situation. In order to fully understand its process though, first an understanding of how the a multinomial logit works is necessary.
